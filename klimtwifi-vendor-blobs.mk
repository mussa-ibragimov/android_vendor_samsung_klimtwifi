...
PRODUCT_COPY_FILES += \
    ...
    vendor/samsung/klimtwifi/proprietary/bin/drmserver:system/bin/drmserver \
    ...
    vendor/samsung/klimtwifi/proprietary/etc/wifi/wpa_supplicant_overlay.conf:system/etc/wifi/wpa_supplicant_overlay.conf \
    ...
    vendor/samsung/klimtwifi/proprietary/lib/drm/libomaplugin.so:system/lib/drm/libomaplugin.so \
    vendor/samsung/klimtwifi/proprietary/lib/drm/libplayreadyplugin.so:system/lib/drm/libplayreadyplugin.so \
    vendor/samsung/klimtwifi/proprietary/lib/drm/libprgenericplugin.so:system/lib/drm/libprgenericplugin.so \
    ...
    vendor/samsung/klimtwifi/proprietary/lib/libdrmframework.so:system/lib/libdrmframework.so \
    ...
    vendor/samsung/klimtwifi/proprietary/media/battery_cover.spi:system/media/battery_cover.spi \
    vendor/samsung/klimtwifi/proprietary/media/battery_error.spi:system/media/battery_error.spi \
    vendor/samsung/klimtwifi/proprietary/media/battery_low.spi:system/media/battery_low.spi \
    vendor/samsung/klimtwifi/proprietary/media/battery_temperature_error.spi:system/media/battery_temperature_error.spi \
    vendor/samsung/klimtwifi/proprietary/media/battery_temperature_limit.spi:system/media/battery_temperature_limit.spi \
    vendor/samsung/klimtwifi/proprietary/media/dock_error.spi:system/media/dock_error.spi \
    vendor/samsung/klimtwifi/proprietary/media/incompatible_charger.spi:system/media/incompatible_charger.spi \
    vendor/samsung/klimtwifi/proprietary/media/lcd_density.txt:system/media/lcd_density.txt \
    vendor/samsung/klimtwifi/proprietary/media/percentage.spi:system/media/percentage.spi \
    vendor/samsung/klimtwifi/proprietary/media/wave_loop.spi:system/media/wave_loop.spi \
    vendor/samsung/klimtwifi/proprietary/media/wireless_left.spi:system/media/wireless_left.spi \
    vendor/samsung/klimtwifi/proprietary/media/wireless_right.spi:system/media/wireless_right.spi \
    ...
    vendor/samsung/klimtwifi/proprietary/vendor/lib/media/LMspeed_508.emd:system/vendor/media/LMspeed_508.emd \
    vendor/samsung/klimtwifi/proprietary/vendor/lib/media/PFFprec_600.emd:system/vendor/media/PFFprec_600.emd \
    vendor/samsung/klimtwifi/proprietary/vendor/lib/liboemcrypto.so:system/vendor/lib/liboemcrypto.so \
    vendor/samsung/klimtwifi/proprietary/vendor/lib/libbt-vendor.so:system/vendor/lib/libbt-vendor.so \
